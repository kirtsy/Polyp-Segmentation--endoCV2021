...
from .Res2Net_v1b import res2net50_v1b_26w_4s #res2net50_v1b_26w_4s
...
class PraNet(nn.Module):
    ...
    def forward(self, x):
        ...
        crop_4 = F.interpolate(ra5_feat, scale_factor=0.25, mode='bilinear')        # NOTES: Sup-1 (bs, 1, 44, 44) -> (bs, 1, 11, 11)
